...
class ProjectManager {
  ...
  loadProjects() {
    ...
    // We need to hydrate the objects, as json is parsed into default objects
    this.projects = projectsFromStorage.map(
      (project) => new Project(project.id, project.title, project.description)
    );
  }
}
