...
class Viewcontroller {
    ...
    todos.map((todo, index) => {
      ...
      if (
        todo.checked == true
          ...
          : (checkmark.className = "checkmark-btn unchecked")
      );
      ...
      priority.className = "todo-priority-details";
  ...
  addProjectCreationMenu(project) {
    if (document.querySelector("#project-create-menu") != null) {
      return;
    }
  ...
  addTodoDCreationMenu(todo) {
    if (document.querySelector("#todo-create-menu") != null) {
      return;
    }
